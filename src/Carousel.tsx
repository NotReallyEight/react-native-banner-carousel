...
> {
  ...
  // Make sure the carousel is not sliding when a prop that is not the index has changed
  ...
  public componentWillMount() {
    // Whenever the index prop changes, go to the new index page
    if (this.oldIndex !== this.props.index) {
      this.gotoPage(this.props.index);
      this.oldIndex = this.props.index;
    }
